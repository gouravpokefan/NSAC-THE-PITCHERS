...
export default class Rocks2 extends Sprite {
  constructor(...args) {
    ...
    this.costumes = [
      new Costume("rocks", "./Rocks2/costumes/rocks.svg", { x: 59, y: 15 }),
      new Costume("rocks2", "./Rocks2/costumes/rocks2.svg", { x: 59, y: 15 }),
      new Costume("rocks3", "./Rocks2/costumes/rocks3.svg", { x: 59, y: 15 }),
      new Costume("rocks4", "./Rocks2/costumes/rocks4.svg", { x: 59, y: 15 }),
      new Costume("rocks5", "./Rocks2/costumes/rocks5.svg", { x: 59, y: 15 })
    ];
